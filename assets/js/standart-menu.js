document.addEventListener('DOMContentLoaded', async function() {
  ...
  async function loadData() {
    const menuResp = await fetch('../EaseBodyFood/assets/data/menu.json');
    menuData = await menuResp.json();
    const dishesResp = await fetch('../EaseBodyFood/assets/data/dishes.json');
    ...
    return `
      <div class="menu-card">
        <div class="menu-card-img-wrap">
          <img src="${dish.img || '../EaseBodyFood/assets/img/food1.jpg'}" alt="${dish.title}" class="menu-card-img">
