document.addEventListener('DOMContentLoaded', async function() {
  ...
  async function loadData() {
    const menuResp = await fetch('../EasyBodyFoodSite/assets/data/menu.json');
    menuData = await menuResp.json();
    const dishesResp = await fetch('../EasyBodyFoodSite/assets/data/dishes.json');
    ...
    return `
      <div class="menu-card">
        <div class="menu-card-img-wrap">
          <img src="${dish.img || '../EasyBodyFoodSite/assets/img/food1.jpg'}" alt="${dish.title}" class="menu-card-img">
